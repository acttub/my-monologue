...
// 인물의 성별과 작품 내 관계.
// 이게 없으면 분류기가 관습적 성역할로 빈칸을 채운다 — 실제로 여성 화자를 "남편이 아내에게"로
// 뒤집은 사례가 나왔다(2026-07-20 3차 검토, 축 C). 이름만으로는 모델이 누구인지 모른다.
const CHARACTER_INFO = {
  // 병자삼인
  "정필수": "남성. 아내가 학교 교사가 되면서 집안일을 맡게 된 남편",
  "공소사": "여성. 여의사이며 하계순의 아내",
  "박원청": "남성. 김원경의 남편",
  "하계순": "남성. 공소사의 남편이자 교사",
  "김원경": "여성. 학교 사무원이며 박원청의 아내",
  "설월": "여성. 기생",
  // 규한
  "이씨": "여성. 어린 나이에 시집와 시집에 남겨진 며느리. 남편은 일본 유학 중",
  "최씨": "여성. 이씨와 같은 처지의 이웃 며느리",
  "노파": "여성. 나이 든 이웃",
  // 인형의 집
  "노라": "여성. 헬머의 아내",
  "헬머": "남성. 노라의 남편이자 은행장",
  "린데": "여성. 노라의 옛 친구",
  "크록스타": "남성. 헬머가 일하는 은행의 직원",
  "랑크": "남성. 의사이며 헬머 부부의 친구",
  "안네": "여성. 노라 집의 유모",
  "엘렌": "여성. 노라 집의 하녀"
};
...
for (const w of WORKS) {
  ...
  const cands = speeches
    ...
    .map((s) => ({
      ...
      character: s.who,
      characterInfo: CHARACTER_INFO[s.who] || null,
      chars: s.body.length,
      body: s.body
    }));
